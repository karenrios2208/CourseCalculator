  ...
  <div class="home_content">
    ...
    <form method="GET" id="my_form"></form>
          ...
          <table id="requestContents" class = "styl">
              ...
              <tr>
                <td><input type="text" name="nombre2" form="my_form" placeholder="Partial Project" style="width: 136px"></td>
              ...
              <tr>
                <td><input type="text" name="nombre3" form="my_form" placeholder="Partial Exams" style="width: 136px"></td>
              ...
              <tr>
                <td><input type="text" name="nombre5" form="my_form" placeholder="Activities" style="width: 136px"></td>
